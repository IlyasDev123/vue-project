<template>
  <h1 class="text__center fw__700">How did you hear about us?</h1>
  <div class="progreess__bar--talent">
    <div class="progress__barLIne">
      <div class="blue_progress" style="width: 73%"></div>
    </div>
    <div class="progreess__barTitles_holder">
      ...
      <div class="bar__title bar__title--5 completed">
        <div class="title__svgIcon">
          <svg
            width="17"
            height="16"
          ...
          <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.7998 16C13.2181 16 16.7998 12.4183 16.7998 8C16.7998 3.58172 13.2181 0 8.7998 0C4.38153 0 0.799805 3.58172 0.799805 8C0.799805 12.4183 4.38153 16 8.7998 16Z" fill="#578BEF"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M13.7494 6.29289C14.1399 5.90236 14.1399 5.2692 13.7494 4.87867C13.3589 4.48815 12.7257 4.48815 12.3352 4.87867L7.38544 9.82842L5.26412 7.7071C4.8736 7.31658 4.24043 7.31658 3.84991 7.7071C3.45938 8.09763 3.45938 8.73079 3.84991 9.12131L6.67833 11.9497C7.06886 12.3403 7.70202 12.3403 8.09255 11.9497L13.7494 6.29289Z" fill="white"></path></svg>
        </div>
        Account Manager
      </div>
  ...
  <div class="header__AboutFormWrapper">
    <form action="">
      <div class="members__set">
        <fieldset v-for="recruiter in recuriters" :key="recruiter.id">
          <input
            type="radio"
            name="recruiter"
            v-model="id"
            :value="recruiter.id"
            :checked="recruiter.id == id"
            @change="onChange"
            :id="`${recruiter.first_name}`"
          />
          <label :for="`${recruiter.first_name}`">
            <div class="member__imgHolder">
              <img
                :src="'../../new/chirrrp-backend/public' + recruiter.avatar"
                alt=""
              />
            </div>
          </label>
      ...
      <div class="ads__set">
        <fieldset>
          <input
            ...
            v-model="friend"
            :checked="friend"
            @change="selectSocialChange(1)"
          />
          <label for="friends">
            <div class="member__imgHolder">
              <img src="@/assets/images/talent-images/friedns.png" alt="" />
            </div>
          </label>
        </fieldset>
        <fieldset>
          <input
            ...
            v-model="adds"
            :checked="adds"
            @change="selectSocialChange(2)"
          />
          <label for="adds">
            <div class="member__imgHolder">
              <img src="@/assets/images/talent-images/adds.png" alt="" />
            </div>
          </label>
        </fieldset>
      </div>
  ...
  <NextPreviousButton
    previousRouteName="LastQuestion"
    nextRouteName="CustomizeProfile"
...
export default {
  ...
  created() {
    ...
    this.id = formData ? formData.recruiter_id : null;
    this.friend = formData.otherForumn == 1 ? true : null;
    this.adds = formData.otherForumn == 2 ? true : null;
    this.recruiter();
  },
  data() {
    return {
  ...
  methods: {
    ...
    async recruiter() {
      let resposnse = await this.getRecruiters();
      this.recuriters = resposnse;
    },
    onChange() {
      this.adds = null;
      this.friend = null;
