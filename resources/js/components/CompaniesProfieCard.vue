            ...
            >
                ...
                >
                    ...
                    <div class="d__flex d__flex-d-col d__flex-h-center">
                        <h5>
                            {{
                                company.position.company.company_meta
                                    .company_name
                            }}
                        </h5>
                        <span>{{
                            company.position.company.company_meta.current_role
                        }}</span>
                        <router-link
                            :to="{
                                name: 'CompaniesCustomizeProfile',
                                params: { id: company.position_id },
                            }"
...
export default {
    ...
    methods: {
        deletePortfolio() {
            ...
            console.log("psition to delete:", id);
            userService.deletePortfolio(id).then((data) => {
                if (data.data.status != true) {
                    this.$toast.error(data.message);
                } else {
                    console.log("deleted position", data.data);
