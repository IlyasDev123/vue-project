<template>
  <h1 class="text__center">
    What's the most important thing to you <br />when selecting a new employer?
  </h1>
  <div class="progreess__bar--talent">
    <div class="progress__barLIne">
      <div class="blue_progress" style="width: 55%"></div>
    </div>
  ...
  <div class="regsiter_form_holder">
    <form action="#" class="">
      <div class="indutry__holder">
        <fieldset
          v-for="employerSelection in this.$store.state.chirrrpMeta.chirrrpMeta
            .employerSelectionPreference"
        ...
        >
          <input
            ...
            :checked="employerSelection.id == id"
            @change="onChange"
          />
  ...
  <NextPreviousButton
    previousRouteName="AllmostDone"
    nextRouteName="COWorkers"
...
export default {
  ...
  created() {
    ...
    this.id = formData ? formData.employer_selection_preference_id : null;
  },
  methods: {
    onChange() {
      let payload = {
        employer_selection_preference_id: this.id,
      };
