<template>
  <h1 class="text__center">What best describes your Management style?</h1>
  <div class="progreess__bar--talent">
    ...
    <div class="progreess__barTitles_holder">
      ...
      <div class="bar__title bar__title--5 active">
        <div class="title__svgIcon">
          <svg
            width="17"
            height="16"
  ...
  <div class="regsiter_form_holder">
    <form action="#" class="has__svg">
      <div class="indutry__holder">
        <div class="error_message" v-show="errors">
          {{ errors }}
        </div>
        <fieldset
        ...
        >
          <input
            ...
            :checked="ManagementStyle.id == ids[index]"
...
export default {
  ...
  created() {
    ...
    this.ids = formData
      ? formData.management_style_id.map((id) => {
          return id;
        })
      : null;
  },
  methods: {
    ...
    onSubmit() {
      if (this.ids.length == 0) {
        this.errors = "Please Select A Mangement Style!";
      } else {
        this.$router.push({ name: "LoveAboutWork" });
      }
    },
  },
};
