<template>
        ...
        <div class="progreess__barTitles_holder">
            <div class="bar__title bar__title--1 completed">
                <div class="title__svgIcon">
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" style="">
                    ...
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.7998 16C13.2181 16 16.7998 12.4183 16.7998 8C16.7998 3.58172 13.2181 0 8.7998 0C4.38153 0 0.799805 3.58172 0.799805 8C0.799805 12.4183 4.38153 16 8.7998 16Z" fill="#578BEF"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M13.7494 6.29289C14.1399 5.90236 14.1399 5.2692 13.7494 4.87867C13.3589 4.48815 12.7257 4.48815 12.3352 4.87867L7.38544 9.82842L5.26412 7.7071C4.8736 7.31658 4.24043 7.31658 3.84991 7.7071C3.45938 8.09763 3.45938 8.73079 3.84991 9.12131L6.67833 11.9497C7.06886 12.3403 7.70202 12.3403 8.09255 11.9497L13.7494 6.29289Z" fill="white"></path>
                    </svg>                        
                </div>
                Setect Role
            </div>
    ...
    <h1 class="text__center fw__700 ">One Last Question!</h1>



    <div class="role__btn">
        <router-link   :to="{ name: this.previousRouteName }" class="arrow__anchor arrow__prev">
          <svg
            width="31"
            height="20"
            viewBox="0 0 31 20"
    ...
    <!-- <NextPreviousButton previousRouteName="Hobbies" nextRouteName="HearAboutUs"/> -->
