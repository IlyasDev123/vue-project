...
export default {
    props: {
        ...
        sidebarNavMenu: Boolean,
    },
    created() {
        let user = JSON.parse(localStorage.getItem("user")) || [];
        this.userType = user.type;
        this.getCurrentUser();
        user.type == this.$constants.TALENT
            ? this.getSkill()
            : this.getPositions();
    },
    data() {
...
<template>
    <div>
        <aside v-if="sidebarNavMenu" class="side__bar">
                ...
                <nav class="side__bar-menu">
                    <ul class="side__bar-items">
                        <div v-if="userType == this.$constants.TALENT">
                            ...
                            >
                                <div v-if="sideMenuItem.click == true">
                                    <router-link
                                        :to="{ name: sideMenuItem.routeName }"
                                    >
                                        <div @click="showSubMenu">
                                            <img
                                                :src="
                                                    '../../images/img/' +
                                                    sideMenuItem.src
                                ...
                                >
                                    <router-link
                                        v-for="child in this.$store.state.auth
                                            .userSkill"
                                        :key="child.id"
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            ...
                                            alt=""
                                        />
                                        <span>{{ child.profession.name }}</span>
                                    </router-link>
                                </div>
                            </li>
                        </div>
